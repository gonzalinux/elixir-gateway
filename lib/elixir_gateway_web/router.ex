defmodule ElixirGatewayWeb.Router do
  ...
  # ACME HTTP-01 challenge responses — no pipeline, bypasses BotBlocker/RateLimiter/DomainRouter
  scope "/.well-known" do
    forward("/acme-challenge", ElixirGatewayWeb.Plugs.AcmeChallengePlug)
  end
